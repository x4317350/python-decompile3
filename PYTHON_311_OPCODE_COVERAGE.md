...
| ---: | --- | --- | :---: | :---: | --- | --- | --- | --- | --- |
| 0 | `CACHE` | internal | 是 | 否 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
...
| 31 | `MATCH_MAPPING` | match | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/06_match.py` |
| 32 | `MATCH_SEQUENCE` | match | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/06_match.py` |
| 33 | `MATCH_KEYS` | match | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/06_match.py` |
| 35 | `PUSH_EXC_INFO` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 36 | `CHECK_EXC_MATCH` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 37 | `CHECK_EG_MATCH` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/07_exception_group.py` |
| 49 | `WITH_EXCEPT_START` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 50 | `GET_AITER` | generator_async | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 51 | `GET_ANEXT` | generator_async | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 52 | `BEFORE_ASYNC_WITH` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 53 | `BEFORE_WITH` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 54 | `END_ASYNC_FOR` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 60 | `STORE_SUBSCR` | store | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
...
| 89 | `POP_EXCEPT` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 90 | `STORE_NAME` | store | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 91 | `DELETE_NAME` | delete | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/09_straight_line.py` |
| 92 | `UNPACK_SEQUENCE` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
...
| 102 | `BUILD_TUPLE` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 103 | `BUILD_LIST` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 104 | `BUILD_SET` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 105 | `BUILD_MAP` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 106 | `LOAD_ATTR` | load | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/01_functions_classes.py` |
| 107 | `COMPARE_OP` | expression | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 108 | `IMPORT_NAME` | import | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/01_functions_classes.py` |
| 109 | `IMPORT_FROM` | import | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/01_functions_classes.py` |
| 110 | `JUMP_FORWARD` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 111 | `JUMP_IF_FALSE_OR_POP` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 112 | `JUMP_IF_TRUE_OR_POP` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 114 | `POP_JUMP_FORWARD_IF_FALSE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 115 | `POP_JUMP_FORWARD_IF_TRUE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 116 | `LOAD_GLOBAL` | load | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 117 | `IS_OP` | expression | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 118 | `CONTAINS_OP` | expression | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 119 | `RERAISE` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 120 | `COPY` | statement_protocol | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 122 | `BINARY_OP` | expression | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 123 | `SEND` | generator_async | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 124 | `LOAD_FAST` | load | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 125 | `STORE_FAST` | store | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 126 | `DELETE_FAST` | delete | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/05_exceptions_with.py` |
| 128 | `POP_JUMP_FORWARD_IF_NOT_NONE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 129 | `POP_JUMP_FORWARD_IF_NONE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 130 | `RAISE_VARARGS` | exception | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/07_exception_group.py` |
| 131 | `GET_AWAITABLE` | generator_async | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 132 | `MAKE_FUNCTION` | call_function_class | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 133 | `BUILD_SLICE` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 134 | `JUMP_BACKWARD_NO_INTERRUPT` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/04_generators_async.py` |
| 135 | `MAKE_CELL` | internal | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/01_functions_classes.py` |
...
| 155 | `FORMAT_VALUE` | statement_protocol | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 156 | `BUILD_CONST_KEY_MAP` | collection | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
...
| 171 | `CALL` | call_function_class | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 172 | `KW_NAMES` | internal | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/00_expressions.py` |
| 173 | `POP_JUMP_BACKWARD_IF_NOT_NONE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 174 | `POP_JUMP_BACKWARD_IF_NONE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
| 175 | `POP_JUMP_BACKWARD_IF_FALSE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/03_comprehensions.py` |
| 176 | `POP_JUMP_BACKWARD_IF_TRUE` | control_flow | 是 | 是 | missing | missing | missing | missing | `test/simple_source/311/02_control_flow.py` |
